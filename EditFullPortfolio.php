...
if(isset($_POST["Submit"])){
  ...
  $Target="PortfolioPic/".basename($_FILES["port_bunner"]["name"]);
 ...
 // $DateTime = strftime("%Y-%m-%d %H:%M:%S",$CurrentTime);
  ...
  if (isset($_GET["EditPortfolio"])) {
     $EditPortfolioFromUrl = $_GET["EditPortfolio"];
  // global $dbcon;
  // $ExpertId = $_SESSION["User_Id"];
  $Query= "UPDATE portfolio SET port_title = '$PortTitle', port_bunner = '$PortBunner', portfolio_text = '$Portfolio'
  WHERE portfolio.id = '$EditPortfolioFromUrl'";
 ...
 if ($Excute) {
    ...
    Redirect_to("EditFullPortfolio.php");
  }
}
     ...
     <div class="col-md-8">
      <div class="addNewPost-container">
       ...
       <?php 
          ...
          $EditPortfolioFromUrl = $_GET["EditPortfolio"];
          $Query = "SELECT * FROM portfolio INNER JOIN expert_bio ON portfolio.expert_id = expert_bio.id WHERE portfolio.id = '$EditPortfolioFromUrl'";
          $Excute = mysqli_query($dbcon,$Query);
        ...
        <form action="EditFullPortfolio.php?EditPortfolio=<?php echo $EditPortfolioFromUrl; ?>" method="post" enctype="multipart/form-data">
           <p></p>
         <span>Existing Portfolio Picture:</span> 
         <img src="PortfolioPic/<?php echo $PortBunner; ?>" with=270px height=100px;>
         <p></p>
         <label>Change Portfolio Picture :</label>
         <i class="fas fa-camera"></i> <input type="File" name="port_bunner">
         <p></p>
         <label for="Title">Title :</label>
         <input type="text" name="port_title" value="<?php echo $PortTitle ?>">
         <p></p>
          <label>About Portfolio :</label>
         <p></p>
         <textarea name="portfolio_text" placeholder="Edit Portfolio"><?php echo $Portfolio; ?></textarea>
         <p></p>
         <input type="submit" name="Submit" value="Update Portfolio">
         <p></p>
       </form>
       </div>
     </div>
