...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/authorPost.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- Expert navbar -->
 <div class="row">
  <div class="col-md-3">
     ...
     <a href="authorPost.php?Page=1"  id="dashboard-active"><i class="fas fa-list"></i>Articles</a>
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       <h1>Articles</h1>
       <p>&raquo By various Experts</p>
       <div class="searchForm">
            <form action="authorPost.php">
       ...
       // Query when pagination is Active i.e expert-articles.php?Page=1
        ...
        // $ShowPostFrom=($Page*5)-5; if search page=2, multply it by 5 then subtract the result by 5=5 articles per page
          $ViewQuery = "SELECT article.id, fname,lname, profile_pic,email,title, profession, date_published, article_text, article_bunner, category, article_title, expert_id FROM article INNER JOIN expert_bio ON article.expert_id = expert_bio.id ORDER BY date_published DESC LIMIT $ShowPostFrom,5";}
           else{
       
          $ViewQuery = "SELECT article.id, fname,lname, profile_pic,email,title, profession, date_published, article_text, article_bunner, category, article_title, expert_id FROM article INNER JOIN expert_bio ON article.expert_id = expert_bio.id ORDER BY date_published DESC LIMIT 0,5";}
           ...
           <div class="article_content">
            ...
            <p id="article_date"><i class="fas fa-calendar-alt"></i> <?php echo $DatePublished; ?></p>
            ...
            <?php
             ...
             <a href="AuthorFullPost.php?id=<?php echo $ArticleId; ?>">Read More</a>
          </div>

            <div class="article_author">
              <a href="authorProfile.php?id=<?php echo $ExpertId?>">
               <img src="ProfilePic/<?php echo $ProfilePic; ?>" id="profile-pic" vspace=25 hspace=10 />
               <p><?php echo $Title; ?> <?php echo $Fname; ?> <?php echo $Lname; ?></p>
               <p id="profession"><?php echo $Profession; ?></p>
             </a>
          </div>
         </div>
         <?php }//end While Loop ?>
      ...
      ?>
      <a href="authorPost.php?Page=<?php echo $Page-1?>"> &laquo; </a> 
      <?php } ?>
      <?php } ?>
    <!-- end Back btn -->
    ...
    <a href="authorPost.php?Page=<?php echo $i; ?>" id="article-pagination-active"><?php echo $i; ?></a>
    <?php
      }else{
    ?>
    <a href="authorPost.php?Page=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?> <!-- end else -->
<?php } ?>
          <?php } ?> <!-- end forloop -->
    <!-- Forward btn -->
      <?php
        ...
        ?>
           <a href="authorPost.php?Page=<?php echo $Page+1 ?>"> &raquo; </a>
          <?php } ?>
          <?php } ?> <!-- End Forward btn -->
     </div>
      <!-- End Pagination -->
