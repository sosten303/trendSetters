...
if(isset($_POST["Submit"])){
  $Category = mysqli_real_escape_string($dbcon,trim($_POST["catename"]));
 ...
 // $DateTime = strftime("%Y-%m-%d %H:%M:%S",$CurrentTime);
  ...
  $_SESSION["ErrorMessage"]="too much text";
  Redirect_to("categories.php");
}else{
  // global $dbcon;
  $Query= "INSERT INTO category(datetime,catename,expertname)
...
<!-- Expert navbar -->
 <div class="row">
   <div class="col-md-4">
     ...
     <a href="categories.php" id="dashboard-active"><i class="fas fa-tags"></i>Article Categories</a>
     ...
     <div class="col-md-8">
      <div class="category-container">
       ...
       <form action="categories.php" method="post">
         ...
         <input type="text" name="catename" placeholder="category name" id="Category">
       ...
       <div style="overflow-x:auto;">
         <table>
           ...
           <tr>
             ...
             <td><a href="deletecategory.php?id=<?php echo $Id; ?>" id="delete-btn">Delete</a></td>
           </tr>
         <?php } ?>
         </table>
       </div>
