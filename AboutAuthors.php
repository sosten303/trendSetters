...
<meta charset="utf-8">
	...
	<link rel="stylesheet" type="text/css" href="css/AboutAuthors.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- ************************** Start Expert Dropdown ************************************** -->
        ...
        <div class="dropdown-content-expert">
                  <?php 
                 $ViewQuery="SELECT * FROM expert_bio ORDER BY id DESC LIMIT 0,5";//limt means display only 5 articles on this page then triger next to view other 5
           ...
           ?>
          <a href="AboutAuthorPost.php?id=<?php echo $ExpertId ?>"><img src="ProfilePic/<?php echo $ProfilePic; ?>"/><?php echo htmlentities($Title); ?> <?php echo htmlentities($Fname); ?> <?php echo htmlentities($Lname); ?>
            <p><i class="fas fa-user-tie"></i> <?php echo htmlentities($Profession); ?></p>
          </a>
                                     
         <?php }//end While Loop ?>
         <a href="AboutAuthors.php?Page=2"> more</a>
...
<div class="row">
  <div class="col-md-12">
       ...
       //Query when Search Button is Active
           if (isset($_GET["search-btn"])) {
               ...
               // $ExpertId = $_SESSION["User_Id"];
                $ViewQuery = "SELECT * FROM expert_bio WHERE fname LIKE '%$Search%' OR lname LIKE '%$Search%'";
           }
          ...
          elseif (isset($_GET["Page"])) {
              ...
              if ($Page == 0 || $Page < 1) {
                ...
                $ShowPostFrom = ($Page*5)-5;
                  ...
                  $ViewQuery="SELECT * FROM expert_bio ORDER BY id DESC LIMIT $ShowPostFrom,5";}
           else{
                  $ViewQuery="SELECT * FROM expert_bio ORDER BY id DESC LIMIT 0,5";}//limt means display only 5 articles on this page then triger next to view other 5
           $Execute = mysqli_query($dbcon,$ViewQuery);
           ...
           <div class="author_content">
            ...
            <p><b><?php echo htmlentities($Title); ?></b> <?php echo htmlentities($Fname); ?> <?php echo htmlentities($Lname); ?></p>
            <a href="AboutAuthorPost.php?id=<?php echo $ExpertId ?>"> Connnect</a>
            <p><i class="fas fa-user-tie"></i> <?php echo htmlentities($Profession); ?></p>
          </div>
         <?php }//end While Loop ?>

    <div class="author_pagination">
          <!-- Pagination Begin -->
      ...
      ?>
      <a href="AboutAuthors.php?Page=<?php echo $Page-1?>"> &laquo; </a> 
      <?php } ?>
      <?php } ?>
    <!-- end Back btn -->
     ...
     <!-- Adding links to pagination -->
        <?php
         $QueryPagination = "SELECT COUNT(*) FROM expert_bio";
    ...
    <a href="AboutAuthors.php?Page=<?php echo $i; ?>" id="author_pagination-active"><?php echo $i; ?></a>
    <?php
      }else{
    ?>
    <a href="AboutAuthors.php?Page=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?> <!-- end else -->
<?php } ?>
          <?php } ?> <!-- end forloop -->
    <!-- Forward btn -->
      <?php
        ...
        ?>
           <a href="AboutAuthors.php?Page=<?php echo $Page+1 ?>"> &raquo; </a>
          <?php } ?>
          <?php } ?> <!-- End Forward btn -->
</div>
      <!-- End Pagination -->
