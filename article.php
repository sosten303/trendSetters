   ...
   <div class="wrapper active-element">
     <header class="main-header">
        <nav>
          ...
          <div id="title-head">
                <h2>Articles For Experts</h2>
                <?php echo SuccessMessage();  ?>
                 <a href="adminlogout.php">You can logout</a>
              </div>
       	</div>
       ...
       //When this Category is Active
        ...
        // $ShowPostFrom=($Page*5)-5; if search page=2, multply it by 5 then subtract the result by 5=5 articles per page
          $ViewQuery="SELECT * FROM admin_panel ORDER BY datetime desc LIMIT $ShowPostFrom,5";
            ...
            // Dedult Query for expert-articles.php
           $ViewQuery="SELECT * FROM admin_panel ORDER BY datetime desc LIMIT 0,5";} //limt means display only 5 articles on this page then triger next to view other 5
...
<div class="article-container">
  <div class="article-details">
    <span id="datetime"><i class="far fa-calendar"></i><?php echo htmlentities($DateTime);?></span>
    <span id="expert"><i class="fas fa-user-tie"></i><?php echo htmlentities($Admin);?> <i class="fas fa-caret-down"></i>|</span>
      <?php
         ...
         <img src="Upload/<?php echo $Image; ?>">
             ...
             <div>
               ...
               <p><?php
                ...
                echo $Post;?></p>
                <a href="expertfullpost.php?id=<?php echo $PostId?>"> Read More</a>
             </div>
           </div>
