...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/AuthorPortfolio.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- Expert navbar -->
 <div class="row">
   <div class="col-md-3">
     ...
     <?php } ?> <!-- End if Condition -->
     <a href="AuthorPortfolio.php?Page=1" id="dashboard-active"><i class="fas fa-user-tie"></i>Expert Portfolios</a>
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       ...
       <div class="searchForm">
            <form action="AuthorPortfolio.php">
          ...
          $ViewQuery = "SELECT portfolio.id, fname,lname, profile_pic,email,title, profession, date_published, portfolio_text, port_bunner, port_title FROM portfolio INNER JOIN expert_bio ON portfolio.expert_id = expert_bio.id ORDER BY date_published DESC LIMIT 0,5";}
           ...
           ?>
            ...
            <p>
             ...
             ?>
             <a href="AuthorFullPortfolio.php?id=<?php echo $PortId ?>">Read More</a>
           </p>            
     ...
     <div class="article-pagination">
      ...
      ?>
      <a href="AuthorPortfolio.php?Page=<?php echo $Page-1?>"> &laquo; </a> 
      <?php } ?>
      <?php } ?>
    <!-- end Back btn -->
    ...
    <a href="AuthorPortfolio.php?Page=<?php echo $i; ?>" id="article-pagination-active"><?php echo $i; ?></a>
    <?php
      }else{
    ?>
    <a href="AuthorPortfolio.php?Page=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?> <!-- end else -->
<?php } ?>
          <?php } ?> <!-- end forloop -->
    <!-- Forward btn -->
      <?php
        ...
        ?>
           <a href="AuthorPortfolio.php?Page=<?php echo $Page+1 ?>"> &raquo; </a>
          <?php } ?>
          <?php } ?> <!-- End Forward btn -->
    </div>
      <!-- End Pagination -->
