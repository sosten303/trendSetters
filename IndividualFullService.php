...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/IndividualFullService.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
     ...
     <a href="adminservice.php"><i class="fas fa-box"></i>Share Service</a>
      ...
      <?php
        ...
        if ($TotalRaws) {
          ...
          <a href="IndividualService.php?Page=1" id="dashboard-active"><i class="fas fa-user-tag"></i> Services <span style="background-color: #00b4ff; color: #ffffff; padding: 1px 3px; border-radius: 2px;"><?php echo $TotalRaws; ?></span></a>
     <?php } ?> <!-- End if Condition -->
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       ...
       <?php
           ...
           $ExpertId = $_SESSION["User_Id"];
           $ServiceIdFromUrl = $_GET["id"];
           $ViewQuery = "SELECT service.id, fname, lname, profile_pic, email, title, profession, category, date_published, service_text, service_bunner, service_title FROM service INNER JOIN expert_bio ON service.expert_id = expert_bio.id WHERE service.id = '$ServiceIdFromUrl'";
           ...
           <div class="service_content">
            ...
            <p id="service_date"><i class="fas fa-calendar-day"></i> <?php echo $DatePublished; ?></p>
            <img src="ServicePic/<?php echo $ServiceBunner; ?>" />
            <p><?php echo nl2br($Service);?></p>
            <p><b>Category :</b><?php echo $Category; ?></p>

            <div class="service_action">
               <a href="EditService.php?EditService=<?php echo $ServiceId ?>" id="edit_service">Edit Service</a>
               <a href="DeleteService.php?DeleteService=<?php echo $ServiceId ?>" id="delete_service">Delete Service</a>
            </div>
