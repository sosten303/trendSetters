  ...
  <div class="row">
    <div class="col-md-12">
     <nav class="main_nav" id="nav">
      ...
      <a href="ccz-about.php" id="active">About</a>
...
<div class="row">
  <div class="col-md-12">
    ...
    <h2>About Us</h2>
    <p>CCZambia is a group of proffesional Contractors in various fields of constraction; Bricklying, Tiling, Electrical, plumbing and capentry. This group was formed by Benny Musonda in 2001. Ever since they have been proven the BEST contractors and consultants in Zambia and other countries.</p>
    <p><b>Mission</b>: <em>To Build a Nation with Quality Infrustracture</em> <i class="fas fa-quote-right"></i></p>
  </div>
