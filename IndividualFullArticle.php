...
<html>
<head>
	<title>Individual Full Article</title>
	<meta charset="utf-8">
	<meta lang="eng">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
	<link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
	<link rel="stylesheet" type="text/css" href="css/IndividualFullArticle.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       ...
       <?php
           ...
           $ViewQuery = "SELECT article.id, fname,lname, profile_pic,email,title, profession, date_published, article_text, article_bunner, category, article_title FROM article INNER JOIN expert_bio ON article.expert_id = expert_bio.id WHERE article.id = '$ArticleIdFromUrl'";
           ...
           <div class="article_content">
            ...
            <p id="article_date">&raquo <?php echo $Title; ?> <?php echo $Fname; ?>
            <?php echo $Lname; ?> | <i class="fas fa-calendar-day"></i><?php echo $DatePublished; ?></p>
            <img src="Upload/<?php echo $Image; ?>" width=600; height=400 />
            <p><b>Category :</b> <?php echo $Category; ?></p>

              <?php echo nl2br($Article); ?>
            <div class="action">
             <a href="EditFullArticle.php?EditArticle=<?php echo $ArticleId ?>" id="edit_article">Edit Article</a>
             <a href="DeleteArticle.php?DeleteArticle=<?php echo $ArticleId ?>" id="delete_article">Delete Article</a>
           </div>
