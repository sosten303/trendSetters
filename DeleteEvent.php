...
if(isset($_POST["Submit"])){
  ...
  if (isset($_GET["DeleteEvent"])) {
     $DeleteEventFromUrl = $_GET["DeleteEvent"];
  // global $dbcon;
  // $ExpertId = $_SESSION["User_Id"];
  $Query= "DELETE FROM event WHERE event.id = '$DeleteEventFromUrl'";
 ...
 if ($Execute) {
    ...
    $_SESSION["ErrorMessage"]=" Failed to Delete Client Try Again !";
    Redirect_to("DeleteEvent.php");
  }
}
     ...
     <div class="col-md-8">
      <div class="addNewPost-container">
       ...
       <?php 
          ...
          $DeleteEventFromUrl = $_GET["DeleteEvent"];
          $Query = "SELECT * FROM event INNER JOIN expert_bio ON event.expert_id = expert_bio.id WHERE event.id = '$DeleteEventFromUrl'";
          $Execute = mysqli_query($dbcon,$Query);
        ...
        <div>
          <form action="DeleteEvent.php?DeleteEvent=<?php echo $DeleteEventFromUrl; ?>" method="post" enctype="multipart/form-data"/>
             <span>Existing Event Picture / Bunner :</span> 
            <img disabled src="EventPic/<?php echo $EventBunner; ?>" with=270px height=100px; />
            <label for="EventImage">Event Image</label>
            <p></p>
            <i class="fas fa-camera"></i> <input disabled type="File" name="event_bunner" id="EventImage"/>
            <p></p>
            <label for="Category">Category</label>
            <p></p>
            <input disabled type="text" name="category" id="Category" placeholder="Change Category" value="<?php echo $Category ?>" />
            <p></p>
            <label for="Theme">Theme</label>
            <p></p>
            <input disabled type="text" name="theme" id="Theme" placeholder="Change Theme" value="<?php echo $Theme ?>" />
            <p></p>
            <label for="Venue">Venue</label>
            <p></p>
            <i class="fas fa-map-marker-alt"></i> <input disabled type="text" name="venue" id="Venue" placeholder="Change Venue" value="<?php echo $Venue ?>" />
            <p></p>
            <label for="Time">Time</label>
            <p></p>
            <i class="fas fa-clock"></i> <input disabled type="text" name="event_time" id="Time" placeholder=" from 00:00 to 00:00 AM or PM" value="<?php echo $EventDate ?>" />
            <p></p>
             <label for="DateUpcoming">Up Coming Event</label>
             <p></p>
            <i class="fas fa-calendar-alt"></i> <input disabled type="date" name="event_date" id="DateUpcoming" placeholder=" dd/mm/yy" value="<?php echo $EventDate ?>" />
            <p></p>
             <label for="Description"><i class="fas fa-pen"></i> Description</label>
             <p></p>
            <textarea disabled type="text" name="event_descrip" id="Description" placeholder=" Any Description, Intro or special Remarks" value="<?php echo $EventDescrip ?>" ></textarea>
            <p></p>
