...
if(isset($_POST["Submit"])){
 ...
 // $DateTime = strftime("%Y-%m-%d %H:%M:%S",$CurrentTime);
  ...
  if (isset($_GET["DeleteClient"])) {
     $DeleteClientFromUrl = $_GET["DeleteClient"];
  // global $dbcon;
  // $ExpertId = $_SESSION["User_Id"];
  $Query= "DELETE FROM client WHERE client.id = '$DeleteClientFromUrl'";
     ...
     <div class="col-md-8">
      <div class="addNewPost-container">
       ...
       <?php 
          ...
          $DeleteClientFromUrl = $_GET["DeleteClient"];
          $Query = "SELECT * FROM client INNER JOIN expert_bio ON client.expert_id = expert_bio.id WHERE client.id = '$DeleteClientFromUrl'";
        ...
        ?>
         <form action="DeleteClient.php?DeleteClient=<?php echo $DeleteClientFromUrl; ?>" method="post" enctype="multipart/form-data">
           <p></p>
         <span>Existing Client Picture / Bunner :</span> 
         <img disabled src="ClientPic/<?php echo $ClientBunner; ?>" with=270px height=100px; />
         <p></p>
         <label>Change Client Picture / Bunner :</label>
         <i class="fas fa-camera"></i> <input disabled type="File" name="client_bunner" />
         <p></p>
         <label for="Title">Client Name :</label>
         <input disabled type="text" name="client_name" value="<?php echo $ClientName ?>" />
         <p></p>
          <label>About Service :</label>
         <p></p>
         <textarea disabled name="about_client" placeholder="Edit Client details"><?php echo $AboutClient; ?></textarea>
         <p></p>
         <input type="submit" name="Submit" value="Delete Client" />
         <p></p>
       </form>
       </div>
     </div>
