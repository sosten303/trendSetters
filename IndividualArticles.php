...
<html>
<head>
	<title>Individual Articles</title>
	<meta charset="utf-8">
	<meta lang="eng">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
	<link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
	<link rel="stylesheet" type="text/css" href="css/IndividualArticles.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
 ...
 <div class="row">
  <div class="col-md-3">
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       ...
       <div class="searchForm">
            <form action="IndividualArticles.php">
       ...
       //Query when Search Button is Active
           if (isset($_GET["search-btn"])) {
               $Search = $_GET["search"];
               $ExpertId = $_SESSION["User_Id"];
               $ViewQuery = "SELECT article.id, fname, lname, profile_pic, email, title, profession, date_published, article_text, article_bunner, category, article_title, expert_id FROM article INNER JOIN expert_bio ON article.expert_id = expert_bio.id AND expert_id = '$ExpertId' WHERE date_published LIKE '%$Search%' OR article_title LIKE '%$Search%' OR category LIKE '%$Search%' OR article_text LIKE '%$Search%'";
          ...
          $ExpertId = $_SESSION["User_Id"];
           $ViewQuery = "SELECT article.id, fname,lname, profile_pic,email,title, profession, date_published, article_text, article_bunner, category, article_title FROM article INNER JOIN expert_bio ON article.expert_id = expert_bio.id WHERE expert_bio.id = '$ExpertId' ORDER BY date_published DESC LIMIT $ShowPostFrom,5";}
           else{
           $ExpertId = $_SESSION["User_Id"];
           ...
           <div class="article_content">
            ...
            <p id="article_date">&raquo
             <?php echo $Title; ?> <?php echo $Fname; ?> <?php echo $Lname; ?> | <i class="fas fa-calendar-day"></i> <?php echo $DatePublished; ?> 
          </p>
            ...
            <p>
              ...
              if (strlen($Article)>150) {
               ...
               echo nl2br($Article);
             ?>
             <a href="IndividualFullArticle.php?id=<?php echo $ArticleId ?>">Read more &raquo</a>
           </p>
          </div>
         <?php }//end While Loop ?>
     ...
     <div class="article-pagination">
      ...
      ?>
      <a href="IndividualArticles.php?Page=<?php echo $Page-1?>"> &laquo; </a> 
      <?php } ?>
      <?php } ?>
    <!-- end Back btn -->
     ...
     <!-- Adding links to pagination -->
        <?php
         $QueryPagination = "SELECT COUNT(*) FROM article INNER JOIN expert_bio ON article.expert_id = expert_bio.id";
    ...
    <a href="IndividualArticles.php?Page=<?php echo $i; ?>" id="article-pagination-active"><?php echo $i; ?></a>
    <?php
      }else{
    ?>
    <a href="IndividualArticles.php?Page=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?> <!-- end else -->
<?php } ?>
          <?php } ?> <!-- end forloop -->
    <!-- Forward btn -->
      <?php
        ...
        ?>
           <a href="IndividualArticles.php?Page=<?php echo $Page+1 ?>"> &raquo; </a>
          <?php } ?>
          <?php } ?> <!-- End Forward btn -->
       </div>
      <!-- End Pagination -->
