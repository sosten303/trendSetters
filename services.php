       	   ...
       	   <div class="main-navbar">
               ...
               <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="#"> Experience</a>
                    <a href="services.php?Page=1" id="active-btn"> Services</a>
                    <a href="#"> Training</a>
...
<div class="col-md-4">
   ...
   <div class="wrapper active-element">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="service">
              ...
              <img src="ServicePic/<?php echo htmlentities($ServiceBunner); ?>"/> 
          ...
          <div class="col-md-6">
            <div class="service">
            <h2><?php echo nl2br($ServiceTitle.'<br>'); ?></h2>
            <p><b>category</b>: <?php echo $Category; ?></p>
            <p><?php
              //limit the number of text to appear
            ...
            <a href="fullservice.php?id=<?php echo $ServiceId; ?>">More Dtails</a>
          </div>
          </div>
     ...
     <?php } ?> <!-- end While loop -->
      ...
      ?>
      <a href="services.php?Page=<?php echo $Page-1?>"> &laquo; </a> 
      <?php } ?>
      <?php } ?>
    <!-- end Back btn -->
        ...
        <?php
         $QueryPagination="SELECT COUNT(*) FROM service";
         $ExcutePagination=mysqli_query($dbcon,$QueryPagination);
         $RowPagination=mysqli_fetch_array($ExcutePagination);
         $TotalServices=array_shift($RowPagination);
        // echo $TotalPosts;
         $ServicesPagination=$TotalServices/5;
         $ServicesPagination=ceil($ServicesPagination);
        // echo $PostPerPage;
         for ($i=1;$i<=$ServicesPagination;$i++){
          if (isset($Page)) {
    ...
    <a href="services.php?Page=<?php echo $i; ?>" id="article-pagination-active"><?php echo $i; ?></a>
    <?php
      }else{
    ?>
    <a href="services.php?Page=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?> <!-- end else -->
<?php } ?>
          <?php } ?> <!-- end forloop -->
 ...
 <!-- Forward btn -->
      <?php
         if (isset($Page)) {
           ...
           if ($Page+1<=$ServicesPagination) {

        ?>
           <a href="services.php?Page=<?php echo $Page+1?>"> &raquo; </a>
          <?php } ?>
          <?php } ?> <!-- End Forward btn -->
