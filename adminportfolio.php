...
if(isset($_POST["Submit"])){
 ...
 // $DateTime = strftime("%Y-%m-%d %H:%M:%S",$CurrentTime);
  ...
  if (empty($Portfolio)){
  $_SESSION["ErrorMessage"]="You need to write your Portfolio and attach image to it";
  Redirect_to("adminportfolio.php");

}else{
  $Query="INSERT INTO portfolio (date_published, port_bunner, portfolio_text, port_title, expert_id)
  VALUES('$DatePublished', '$PortBunner', '$Portfolio', '$PortTitle', '$ExpertId')";
  ...
  if ($Excute) {
     ...
     Redirect_to("IndividualPortfolio.php");
  }else{
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/adminportfolio.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- Expert navbar -->
 <div class="row">
   <div class="col-md-4">
     ...
     <a href="adminportfolio.php" id="dashboard-active"><i class="fas fa-user-tag"></i>Create Portfolio</a>
     ...
     <div class="col-md-8">
      <div class="adminport-container">
       ...
       <!-- ********************************************** -->
        <!-- portfolio form -->
        <div>
          <form action="adminportfolio.php" method="post" enctype="multipart/form-data"/>

            <label for="portfolioImage">Portfolio Image</label>
            <p></p>
           <i class="fas fa-camera"></i> <input type="File" name="port_bunner" id="portfolioImage"/>
           <p></p>
            <label for="Title">Title</label>
            <p></p>
            <input type="text" name="port_title" id="Title" placeholder="heading line">
            <p></p>
            <label for="Portfolio">Portfolio Details</label>
            <p></p>
            <textarea name="portfolio_text" id="Portfolio" placeholder="Write your Portfolio here"></textarea>
             <p></p>
