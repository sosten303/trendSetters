...
if(isset($_POST["Submit"])){
 ...
 // $DateTime = strftime("%Y-%m-%d %H:%M:%S",$CurrentTime);
  $DatePublished = strftime("%B-%d-%Y %H:%M:%S",$CurrentTime);
  ...
  if (empty($ClientName) || empty($ClientBunner)) {
  $_SESSION["ErrorMessage"] = "Client Name and Image are Required !";
  Redirect_to("adminclient.php");

}else{
  $Query = "INSERT INTO client(date_published, client_name, client_bunner, about_client, expert_id)
           VALUES('$date_published', '$ClientName', '$ClientBunner', '$AboutClient', '$ExpertId')";
 ...
 <div class="row">
   <div class="col-md-4">
    <div class="dashboard">
     ...
     <a href="adminclient.php" id="dashboard-active"><i class="fas fa-user-plus"></i>Add Clients</a>
     ...
     <div class="col-md-8">
      <div class="addNewPost-container">
       ...
       <!-- ********************************************** -->
        <!-- portfolio form -->
        <div>
          <form action="adminclient.php" method="post" enctype="multipart/form-data"/>

            <label for="ClientImage">Client Image / Burnner</label>
            <p></p>
            <i class="fas fa-camera"></i> <input type="File" name="client_bunner" id="ClientImage"/>
            <p></p>
            <label for="ClientName">Client Name</label>
            <p></p>
            <input type="text" name="client_name" id="ClientName" placeholder=" This could be an Individual or Firm" />
            <p></p>
            <label for="AboutClient"> About Your Client</label>
            <p></p>
            <textarea name="about_client" id="AboutClient" placeholder="Abrief Description of your client"></textarea>
            <p></p>
