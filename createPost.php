...
if(isset($_POST["Submit"])){
  $Title = mysqli_real_escape_string($dbcon,trim($_POST["article_title"]));
 ...
 // $DateTime = strftime("%Y-%m-%d %H:%M:%S",$CurrentTime);
  ...
  // global $dbcon;
  $Query= "INSERT INTO article(date_published, article_title, article_text, category, article_bunner, expert_id)
           VALUES('$DateTime', '$Title', '$Article', '$Category', '$Image', '$ExpertId')";
 ...
 <div class="row">
     ...
     <?php } ?> <!-- End if Condition -->
      <?php 
       ...
       ?>
       <a href="createPost.php"><i class="fas fa-newspaper"></i>Articles Published<span style="background-color: #00b4ff; color: #ffffff; padding: 1px 3px; border-radius: 2px;"><?php echo $TotalRaws; ?></span></a>
     ...
     <div class="col-md-8">
      <div class="addNewPost-container">
       ...
       <form action="createPost.php" method="post" enctype="multipart/form-data">
         ...
         <p></p>
         <input type="text" name="article_title" placeholder="title" id="title">
         <p></p>
         ...
         <p></p>
         <i class="fas fa-camera"></i> <input type="File" name="article_bunner" id="image" />
         <p></p>
         <label for="Post">Write Post :</label>
         <p></p>
         <textarea name="article_text" id="Post"></textarea>
         <p></p>
