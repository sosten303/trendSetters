...
<meta charset="utf-8">
	...
	<link rel="stylesheet" type="text/css" href="css/fullportfolio.css">
...
<section>
   <div class="row">
     <div class="col-md-3">
       <div class="port-form">
          <h3>Share your Testimony <span id="testmonyIcon"><i class="fas fa-caret-down"></i></span></h3>
         <form action="fullportfolio.php" method="post">
           <label for="Name">Name:</label>
           <p></p>
           <i class="fas fa-user"></i><input type="text" name="username" id="Name" placeholder="User Name" />
           <p></p>
           <label for="Email">Email:</label>
           <p></p>
           <i class="fas fa-envelope"></i><input type="text" name="email" id="Email" placeholder="email" />
           <p></p>
           <label for="Name">Testmony:</label>
           <p></p>
           <textarea name="testmony" placeholder="Write your Testmony here"></textarea>
           <p></p>
           <input type="submit" name="Submit" value="Share">
         </form>
       </div>
         <div class="contact-expert">
           <h3><i class="fas fa-phone"></i> <a href="#aboutExpert"> Contact The Expert</a></h3>
      ...
      <?php
          ...
          $ViewQuery = "SELECT portfolio.id, fname,lname, bio, profile_pic, email, title, profession, date_published, portfolio_text, port_bunner, port_title, expert_id FROM portfolio INNER JOIN expert_bio ON portfolio.expert_id = expert_bio.id WHERE portfolio.id = '$PortIdFromUrl'";
          ...
          <div class="row">
            <div class="col-md-12">
               ...
               <img src="PortfolioPic/<?php echo $PortBunner;?>"/>
                 ...
                 <p><b>Expert incharge :</b> <?php echo htmlentities($Title); ?>
                 <?php echo htmlentities($Fname); ?>
                 <?php echo htmlentities($Lname); ?>
               </p>

               <img src="ProfilePic/<?php echo $ProfilePic;?>" id="ProfilePic" />
