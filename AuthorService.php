...
<html>
<head>
	<title>Experts Service</title>
	<meta charset="utf-8">
	<meta lang="eng">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
	<link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
	<link rel="stylesheet" type="text/css" href="css/AuthorService.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- Expert navbar -->
 <div class="row">
   <div class="col-md-3">
     ...
     <a href="AuthorService.php"  id="dashboard-active"><i class="fas fa-box"></i>Expert Services</a>
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       <h1>Expert Portfolios</h1>
       <div class="searchForm">
            <form action="AuthorService.php">
       ...
       //Query when Search Button is Active
           if (isset($_GET["search-btn"])) {
               $Search=$_GET["search"];
               $ExpertId = $_SESSION["User_Id"];
                $ViewQuery = "SELECT service.id, fname, lname, profile_pic, email, title, profession, category, date_published, service_text, service_bunner, service_title FROM service INNER JOIN expert_bio ON service.expert_id = expert_bio.id WHERE date_published LIKE '%$Search%' OR service_title LIKE '%$Search%' OR service_text LIKE '%$Search%' OR category LIKE '%$Search%'";
           }
       // Query when pagination is Active i.e expert-articles.php?Page=1
        ...
        // $ShowPostFrom=($Page*5)-5; if search page=2, multply it by 5 then subtract the result by 5=5 articles per page
          $ViewQuery = "SELECT service.id, fname, lname, profile_pic, email, title, category, profession, date_published, service_text, service_bunner, service_title FROM service INNER JOIN expert_bio ON service.expert_id = expert_bio.id ORDER BY date_published DESC LIMIT $ShowPostFrom,5";}
           else{
       
          $ViewQuery = "SELECT service.id, fname, lname, profile_pic, email, title, category, profession, date_published, service_text, service_bunner, service_title FROM service INNER JOIN expert_bio ON service.expert_id = expert_bio.id ORDER BY date_published DESC LIMIT 0,5";}
           ...
           ?>
            ...
            <p>
              ...
              if (strlen($Service)>150) {
               ...
               echo nl2br($Service);
             ?>
             <a href="AuthorFullService.php?id=<?php echo $ServiceId ?>">Read More</a>
           </p>
      ...
      ?>
      <a href="AuthorService.php?Page=<?php echo $Page-1?>"> &laquo; </a> 
      <?php } ?>
      <?php } ?>
    <!-- end Back btn -->
    ...
    <a href="AuthorService.php?Page=<?php echo $i; ?>" id="article-pagination-active"><?php echo $i; ?></a>
    <?php
      }else{
    ?>
    <a href="AuthorService.php?Page=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?> <!-- end else -->
<?php } ?>
          <?php } ?> <!-- end forloop -->
    <!-- Forward btn -->
      <?php
        ...
        ?>
           <a href="AuthorService.php?Page=<?php echo $Page+1 ?>"> &raquo; </a>
          <?php } ?>
          <?php } ?> <!-- End Forward btn -->
