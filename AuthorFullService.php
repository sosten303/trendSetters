...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/AuthorFullService.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- Expert navbar -->
 <div class="row">
   <div class="col-md-3">
     ...
     <a href="AuthorService.php?Page=1"  id="dashboard-active"><i class="fas fa-box"></i>Expert Services</a>
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       ...
       <?php
          ...
          $ViewQuery = "SELECT service.id, fname, lname, bio, profile_pic, email, title, category, profession, date_published, service_text, service_bunner, service_title, expert_id FROM service INNER JOIN expert_bio ON service.expert_id = expert_bio.id WHERE service.id = '$ServiceIdFromUrl'";
