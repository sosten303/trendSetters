...
<html>
<head>
	<title>Individual Full Client</title>
	<meta charset="utf-8">
	<meta lang="eng">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
	<link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
	<link rel="stylesheet" type="text/css" href="css/IndividualFullClient.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
     ...
     <a href="adminservice.php"><i class="fas fa-box"></i>Share Service</a>
      ...
      <?php
        ...
        if ($TotalRaws) {
          ...
          <a href="IndividualService.php?Page=1"><i class="fas fa-user-tag"></i> Services <span style="background-color: #00b4ff; color: #ffffff; padding: 1px 3px; border-radius: 2px;"><?php echo $TotalRaws; ?></span></a>
     <?php } ?> <!-- End if Condition -->
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       ...
       <?php
           ...
           $ExpertId = $_SESSION["User_Id"];
           $ClientIdFromUrl = $_GET["id"];
           $ViewQuery = "SELECT client.id, fname, lname, profile_pic, email, title, profession, date_published, about_client, client_bunner, client_name FROM client INNER JOIN expert_bio ON client.expert_id = expert_bio.id WHERE client.id = '$ClientIdFromUrl'";
           ...
           <div class="client_content">
            ...
            <p><?php echo nl2br($AboutClient);?></p>

           <div class="client_action">
               <a href="EditClient.php?EditClient=<?php echo $ClientId ?>" id="edit_client">Edit Client</a>
               <a href="DeleteClient.php?DeleteClient=<?php echo $ClientId ?>" id="delete_client">Delete Client</a>
          </div>
