...
<html>
<head>
	<title>Individual Full Event</title>
	<meta charset="utf-8">
	<meta lang="eng">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
	<link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
	<link rel="stylesheet" type="text/css" href="css/IndividualFullEvent.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
   ...
   <div class="col-md-3">
     ...
     <?php
        ...
        if ($TotalRaws) {
          ...
          <a href="IndividualEvent.php?Page=1" id="dashboard-active"><i class="fas fa-user-tag"></i> Event <span style="background-color: #00b4ff; color: #ffffff; padding: 1px 3px; border-radius: 2px;"><?php echo $TotalRaws; ?></span></a>
     <?php } ?> <!-- End if Condition -->
          ...
          $ExpertId = $_SESSION["User_Id"];
           ...
           <p><b>Date Posted :</b> <?php echo $DatePublished; ?></p>
            ...
            <div class="event_action">
               <a href="EditEvent.php?EditEvent=<?php echo $EventId ?>" id="edit_event">Edit Event</a>
               <a href="DeleteEvent.php?DeleteEvent=<?php echo $EventId ?>" id="delete_event">Delete Event</a>
            </div>
