...
<html>
<head>
	<title>Expert Full Profile</title>
	<meta charset="utf-8">
	<meta lang="eng">
       	   ...
       	   <div class="main-navbar">
               ...
               <div class="dropdown-expert">
                 ...
                 <div class="dropdown-content-expert">
                    <a href="expertFullProfile.php?id=4"> <img src="img/13.jpg"> Benny Musonda</a>
     ...
     <div class="col-md-8">
      <div class="addNewPost-container">
       <h1>Expert Profiles</h1>
         ...
         $Query = "SELECT * FROM expert_bio WHERE id='$BioIdFromURL' ORDER BY datetime desc";
         ...
         <p><b><?php echo $ExpertName; ?></b></p>
         <p><?php echo nl2br($ExpertBio); ?></p>
