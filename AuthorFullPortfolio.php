...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/AuthorFullPortfolio.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- Expert navbar -->
 <div class="row">
  <div class="col-md-3">
     ...
     <?php } ?> <!-- End if Condition -->
     <a href="AuthorPortfolio.php"  id="dashboard-active"><i class="fas fa-user-tie"></i>Expert Portfolios</a>
