...
<!-- Expert navbar -->
 <div class="row">
  <div class="col-md-3">
     ...
     <a href="viewprofile.php?Page=1" id="dashboard-active"><i class="fas fa-users-cog"></i>Expert Profiles</a>
       ...
       //Query when Search Button is Active
          ...
          elseif (isset($_GET["Page"])) {
           ...
           <div class="author_profile_content">
            ...
            <p><i class="fas fa-user-tie"></i> <?php echo $Profession; ?></p>
            
            <p><i class="fas fa-user-circle"></i> <b>Biography :</b>
             <?php
              if (strlen($Bio)>200) {
            ...
            <a href="authorProfile.php?id=<?php echo $ExpertId ?>" id="connect">Connect</a>
            </div>
         <?php }//end While Loop ?>
...
<div class="article-pagination">
      ...
      ?>
      <a href="viewprofile.php?Page=<?php echo $Page-1?>"> &laquo; </a> 
      <?php } ?>
      <?php } ?>
    <!-- end Back btn -->
    ...
    <a href="viewprofile.php?Page=<?php echo $i; ?>" id="article-pagination-active"><?php echo $i; ?></a>
    <?php
      }else{
    ?>
    <a href="viewprofile.php?Page=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?> <!-- end else -->
<?php } ?>
          <?php } ?> <!-- end forloop -->
    <!-- Forward btn -->
      <?php
        ...
        ?>
           <a href="viewprofile.php?Page=<?php echo $Page+1 ?>"> &raquo; </a>
          <?php } ?>
          <?php } ?> <!-- End Forward btn -->
     </div>
      <!-- End Pagination -->
