      ...
      <div class="addNewPost-container">
       <h1>Expert Profiles</h1>
         ...
         <div class="UserComment">
          <img src="ProfilePic/<?php echo $ProfilePic; ?>" with=10; height=70; />
         <p><b><?php echo $Title; ?></b></p>
         <p><b><?php echo $Fname; ?></b></p>
         <p><b><?php echo $Lname; ?></b></p>
         <p><b><?php echo $Profession; ?></b></p>
         <p><?php echo nl2br($ExpertBio); ?></p>

       <a href="expertFullProfile.php?id=<?php echo $BioId?>"> More</a>
       <a href="expertfullpost.php?id=<?php echo $BioId?>"> View Article</a>
         </div>
       <?php } ?>
