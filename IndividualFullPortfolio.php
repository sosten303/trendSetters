...
<html>
<head>
	<title>Individual Full Portfolio</title>
	<meta charset="utf-8">
	<meta lang="eng">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
	<link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
	<link rel="stylesheet" type="text/css" href="css/IndividualFullPortfolio.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       ...
       <?php
           ...
           $ExpertId = $_SESSION["User_Id"];
           $PortIdFromUrl = $_GET["id"];
           $ViewQuery = "SELECT portfolio.id, fname,lname, profile_pic,email,title, profession, date_published, portfolio_text, port_bunner, port_title FROM portfolio INNER JOIN expert_bio ON portfolio.expert_id = expert_bio.id WHERE portfolio.id = '$PortIdFromUrl'";
           ...
           <div class="portfolio_content">
            ...
            <p id="portfolio_date"><i class="fas fa-calendar-day"></i> <?php echo $DatePublished; ?></p>
            <img src="Upload/<?php echo $Image; ?>" />
            <p><?php echo nl2br($Portfolio);?></p>

              <div class="port_action">
               <a href="EditFullPortfolio.php?EditPortfolio=<?php echo $PortfolioId ?>" id="edit_port">Edit Portfolio</a>
               <a href="DeletePortfolio.php?DeletePortfolio=<?php echo $PortfolioId ?>" id="delete_port">Delete Portfolio</a>
              </div>
