...
if(isset($_POST["Submit"])){
 ...
 // $DateTime = strftime("%Y-%m-%d %H:%M:%S",$CurrentTime);
  ...
  if (empty($Venue) || empty($Theme) || empty($UpcomingDate)){
  $_SESSION["ErrorMessage"]="Category, Theme and Image are Required !";
  Redirect_to("adminevent.php");

}else{
  $Query="INSERT INTO event(date_published, theme, venue, event_bunner, category, event_date, event_time, event_descrip, expert_id)
           VALUES('$DateTime', '$Theme', '$Venue', '$EventBunner', '$Category', '$EventDate', '$UpcomingDate', '$EventDesription', '$ExpertId')";

  $Excute=mysqli_query($dbcon,$Query);
  move_uploaded_file($_FILES["event_bunner"]["tmp_name"],$Target);
  if ($Excute) {
     $_SESSION["SuccessMessage"]="Event Shared successfully";
...
<!-- Expert navbar -->
 <div class="row">
   <div class="col-md-4">
     ...
     <a href="adminevent.php" id="dashboard-active"><i class="fas fa-calendar-alt"></i>Share Event</a>
     ...
     <div class="col-md-8">
      <div class="addNewPost-container">
       ...
       <!-- ********************************************** -->
        <!-- Event form -->
        <div>
          <form action="adminevent.php" method="post" enctype="multipart/form-data"/>
            ...
            <p></p>
            <input type="text" name="category" id="Category" placeholder=" Example : Finacil Management" />
            <p></p>
            <label for="Theme">Theme</label>
            <p></p>
            <input type="text" name="theme" id="Theme" placeholder="Your Theme" />
            <p></p>
            <label for="Venue">Venue</label>
            <p></p>
            <i class="fas fa-map-marker-alt"></i> <input type="text" name="venue" id="Venue" placeholder="Share your Venue here" />
            <p></p>
            <label for="Time">Time</label>
            <p></p>
            <i class="fas fa-clock"></i> <input type="text" name="event_time" id="Time" placeholder=" from 00:00 to 00:00 AM or PM" />
            <p></p>
             <label for="DateUpcoming">Up Coming Event</label>
             <p></p>
            <i class="fas fa-calendar-alt"></i> <input type="date" name="event_date" id="DateUpcoming" placeholder=" dd/mm/yy" />
            <p></p>
             <label for="Description"><i class="fas fa-pen"></i> Description</label>
             <p></p>
            <textarea type="text" name="event_descrip" id="Description" placeholder=" Any Description, Intro or special Remarks" ></textarea>
            <p></p>
            <input type="submit" name="Submit" value="Share Event"/>
          </form>
      </div>
       </div>
     </div>
