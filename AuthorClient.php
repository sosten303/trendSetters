...
<html>
<head>
	<title>Experts Clients</title>
	<meta charset="utf-8">
	<meta lang="eng">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
	<link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
	<link rel="stylesheet" type="text/css" href="css/AuthorClient.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- Expert navbar -->
 <div class="row">
   <div class="col-md-3">
     ...
     <a href="AuthorClient.php?Page=1" id="dashboard-active"><i class="fas fa-user-tie"></i>Expert Clients</a>
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       <h1>Experts Clients</h1>
       <div class="searchForm">
            <form action="AuthorClient.php">
          ...
          $ViewQuery = "SELECT client.id, fname, lname, profile_pic, email, title, profession, date_published, client_name, client_bunner, about_client FROM client INNER JOIN expert_bio ON client.expert_id = expert_bio.id ORDER BY date_published DESC LIMIT 0,5";}
           ...
           ?>
            ...
            <p>
             ...
             ?>
             <a href="AuthorFullClient.php?id=<?php echo $ClientId ?>">Read More</a>
           </p>
      ...
      ?>
      <a href="AuthorClient.php?Page=<?php echo $Page-1?>"> &laquo; </a> 
      <?php } ?>
      <?php } ?>
    <!-- end Back btn -->
    ...
    <a href="AuthorClient.php?Page=<?php echo $i; ?>" id="article-pagination-active"><?php echo $i; ?></a>
    <?php
      }else{
    ?>
    <a href="AuthorClient.php?Page=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?> <!-- end else -->
<?php } ?>
          <?php } ?> <!-- end forloop -->
    <!-- Forward btn -->
      <?php
        ...
        ?>
           <a href="AuthorClient.php?Page=<?php echo $Page+1 ?>"> &raquo; </a>
          <?php } ?>
          <?php } ?> <!-- End Forward btn -->
    </div>
      <!-- End Pagination -->
