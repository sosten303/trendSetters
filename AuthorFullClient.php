...
<html>
<head>
  <title>Expert Full Client</title>
  <meta charset="utf-8">
  <meta lang="eng">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
  <link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
  <link rel="stylesheet" type="text/css" href="css/AuthorFullClient.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
     ...
     <div class="col-md-7">
      <div class="addNewPost-container">
       ...
       <?php
          ...
          $ViewQuery = "SELECT client.id, fname, lname, bio, profile_pic, email, title, profession, date_published, about_client, client_bunner, client_name, expert_id FROM client INNER JOIN expert_bio ON client.expert_id = expert_bio.id WHERE client.id = '$ClientIdFromUrl'";
