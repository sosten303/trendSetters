...
//   $Target="Upload/".basename($_FILES["bio"]["name"]);
//   $ExpertId=$_SESSION["User_Id"];
//   $Image=$_FILES["article_bunner"]["name"];
// move_uploaded_file($_FILES["article_bunner"]["tmp_name"], $Target);
 ...
 // $DateTime = strftime("%Y-%m-%d %H:%M:%S",$CurrentTime);
  ...
  if (empty($Fname) || empty($Password) || empty($ConfirmPassword)){
  ...
  // global $dbcon;
  $Query= "INSERT INTO expert_bio(datetime, title, fname, lname, email, gender, dob, bio, phone_number, telephone_number, country, residential, area_code, school, tertiary, qualification, type_of_employment, job_sector, company_name, job_position, position_years, profession, profession_years, password)
           VALUES('$DateTime', '$Title', '$Fname', '$Lname', '$Email', '$Gender', '$DateOfBirth', '$Bio', '$PhoneNumber', '$TelephoneNumber', '$CountryName', '$Residential', '$AreaCode', '$School', '$UniversityCollege', '$Qualification', '$TypeOfEmployment', '$JobSector', '$CompanyName', '$JobPosition', '$PositionYears', '$Profession', '$ProfessionYears', '$Password')";
  $Excute=mysqli_query($dbcon,$Query);
  if ($Excute) {
     $_SESSION["SuccessMessage"]="Registered successfully";
     Redirect_to("confirmexpert.php");
  }else{
    $_SESSION["ErrorMessage"]=" Failed to Register Try Again !";
    Redirect_to("expertregistration.php");
  }
}
...
<html>
<head>
	<title>Expert Registration Form</title>
	<meta charset="utf-8">
	<meta lang="eng">
   ...
   <div class="col-md-6">
     ...
     <div class="col-md-6">
      <div class="adminlogin-container">
       ...
       <p>You arleady have an Account ? <a href="login.php">Login</a></p>
       <p>If you are <b>Not</b> An Expert Please <a href="#">Sign Up here</a></p>
       ...
       ?>
        ...
        <form action="expertregistration.php" method="post">
         ...
         <p></p>
         <input type="text" name="telephone_number" id="TelephoneNumber" />
         <p></p>
         ...
         <p></p>
         <input type="text" name="residential" id="Residential" placeholder="town / city" />
         <p></p>
         <label for="AreaCode">Area Code:</label>
         <p></p>
         <input type="text" name="area_code" id="AreaCode" />
         <p></p>
         ...
         <h1><em>Education Background</em></h1>
          ...
          <p></p>
         <input type="text" name="school" id="School" placeholder=" High / or Seconary School" />
          <P></P>
          <label for="UniversityCollege">University or College:</label>
          <P></P>
          <input type="text" name="tertiary" id="UniversityCollege" />
          <p></p>
          ...
          <input type="text" name="company_name" id="Firm" />
          <p></p>
          <label for="JobPosition"> Your Job Position</label>
          <p></p>
          <input type="text" name="job_position" id="JobPosition" /> 
          <p></p>
          ...
          <p></p>
          <input type="text" name="profession" id="Profession" placeholder="example Business Coach" />
          <p></p>
         ...
         <input type="radio" name="profession_years" id="Experience" value="50 - over years" />50 - over years
          ...
          <!-- <p></p>
          <label for="OtherExperience">Other Profession(s):</label>
          your other fields of work if any
          <p></p>
          <input type="text" name="otherexperience" id="OtherExperience">
          <p></p> -->

         <h1><em>Create User Password</em></h1>
           <p>required to have access and manage your account</p>
          <label>Password:</label>
          <p></p>
           <i class="fas fa-lock-open"></i><input type="password" name="password" placeholder="Password">
         <P></P>
         <label>Confirm Password:</label>
         <p></p>
          <i class="fas fa-lock"></i><input type="password" name="confirm_password" placeholder="Confirm Password">
          <p></p>
          <p>By Creating account you have agreed <a href="#">to our terms & conditions</a></p>
