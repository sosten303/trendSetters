...
<html>
<head>
	<title>Author Full Event</title>
	<meta charset="utf-8">
	<meta lang="eng">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-grid.min.css">
	<link rel="stylesheet" type="text/css" href="fontawesome/css/all.css">
	<link rel="stylesheet" type="text/css" href="css/AuthorFullEvent.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
...
<!-- Expert navbar -->
 <div class="row">
   <div class="col-md-3">
     ...
     <a href="AuthorEvent.php?Page=1" id="dashboard-active"><i class="fas fa-calendar-alt"></i>Expert Events</a>
      ...
      <div class="addNewPost-container">
       ...
       <?php
          ...
          $ExpertId = $_SESSION["User_Id"];
           ...
           $ViewQuery = "SELECT event.id, fname, lname, profile_pic, bio, email, title, profession, date_published, category, venue, theme, event_time, event_date, event_bunner, event_descrip, expert_id FROM event INNER JOIN expert_bio ON event.expert_id = expert_bio.id WHERE event.id = '$EventIdFromUrl'";
           ...
           ?>
            ...
            <h1> <?php echo htmlentities($Theme); ?></h1>
