...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/authorProfile.css">
</head>
<body>
   <!-- navigation bar -->
    <!-- heading -->
 ...
 <div class="row">
  <div class="col-md-3"> 
    ...
    <div class="col-md-4">
      ...
      <div class="expert_article_container">
        <div class="expert_article_head">  
         <h2>Articles</h2>
         <p>&raquo By <?php echo nl2br($Title); ?> <?php echo nl2br($Fname); ?> <?php echo nl2br($Lname); ?></p>
       </div>
         <?php 
          $ExpertId = $_GET["id"];
           // $ExpertId = $_SESSION["User_Id"];
          ...
          <a href="AuthorFullPost.php?id=<?php echo $ExpertId ?>">
          <img src="Upload/<?php echo htmlentities($ArticleBunner); ?>" vspace=1 hspace=20/>
          <p><b>Category :</b> <?php echo nl2br($Category); ?></p>
          <p><i class="fas fa-calendar"></i> <?php echo nl2br($DatePublished); ?></p>
        </a>
          </div>
        <?php } //End While Loop ?>
         </div>
